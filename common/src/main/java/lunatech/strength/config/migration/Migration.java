package lunatech.strength.config.migration;
...
public final class Migration implements ConfigurationTransformation {
    ...
    public static final class Builder {
         ...
         *
         * <p>Strength, move {@code language} into {@code settings}, producing {@code settings.language}:
         ...
         *
         * <p>Strength, move {@code old-key} to {@code section.new-key}:
