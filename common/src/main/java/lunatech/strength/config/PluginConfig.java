...
public class PluginConfig implements VersionedConfig {
    ...
    @Comment(
        "========================================================================================================================\n" +
        "                                                                                                                        \n" +
        " mmmmmmmm  mmmmmm       mm     mmm   mm    mmmm    mm           mm     mmmmmmmm   mmmmmm     mmmm    mmm   mm    mmmm   \n" +
        " \"\"\"##\"\"\"  ##\"\"\"\"##    ####    ###   ##  m#\"\"\"\"#   ##          ####    \"\"\"##\"\"\"   \"\"##\"\"    ##\"\"##   ###   ##  m#\"\"\"\"#  \n" +
        "    ##     ##    ##    ####    ##\"#  ##  ##m       ##          ####       ##        ##     ##    ##  ##\"#  ##  ##m      \n" +
        "    ##     #######    ##  ##   ## ## ##   \"####m   ##         ##  ##      ##        ##     ##    ##  ## ## ##   \"####m  \n" +
        "    ##     ##  \"##m   ######   ##  #m##       \"##  ##         ######      ##        ##     ##    ##  ##  #m##       \"## \n" +
        "    ##     ##    ##  m##  ##m  ##   ###  #mmmmm#\"  ##mmmmmm  m##  ##m     ##      mm##mm    ##mm##   ##   ###  #mmmmm#\"\n" +
        "    \"\"     \"\"    \"\"\" \"\"    \"\"  \"\"   \"\"\"   \"\"\"\"\"    \"\"\"\"\"\"\"\"  \"\"    \"\"     \"\"      \"\"\"\"\"\"     \"\"\"\"    \"\"   \"\"\"   \"\"\"\"\"  \n" +
        "                                                                                                                        \n" +
    ...
    public static class MessagesConfig {
        ...
        @Comment("Message sent when brewing a blacklisted potion is blocked")
