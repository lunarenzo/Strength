...
mavenPublishing {
    ...
    pom {
        ...
        url.set("https://github.com/strengthuser/Strength")
        ...
        developers {
            developer {
                id.set("strengthuser")
                name.set("strengthuser")
                url.set("https://github.com/strengthuser")
                organization.set("StrengthUser")
            }
        }

        scm {
            url.set("https://github.com/strengthuser/Strength")
            connection.set("scm:git:git://github.com/strengthuser/Strength.git")
            developerConnection.set("scm:git:ssh://github.com:strengthuser/Strength.git")
        }
    }
